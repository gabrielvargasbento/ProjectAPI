...
//                    let view = route.body
//                    
//                    if let view = extractSubview(from: view) {
//                        expect(view).to(beAKindOf(CharacterView.self))
//                    } else {
//                        fail("Unexpected view type")
//                    }
//                    
//                }
//                
...
//                    let view = try? route.body.inspect().view(ListRepositoriesView.self)
//
